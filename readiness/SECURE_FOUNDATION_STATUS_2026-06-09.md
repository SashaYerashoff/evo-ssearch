...
- Full live suite before Luxriot runtime wiring: 129 tests passed against
  PostgreSQL 16.
- Fast local suite after Luxriot runtime wiring: 134 tests passed.
- Disposable PostgreSQL 16 live suite after Luxriot runtime wiring: 50 tests
  passed, plus the separate-role Luxriot runtime gate.

## Next execution order

1. Run live PostgreSQL verification for the Luxriot queue runtime and record
   queue/GPU/storage limits on the 50-channel replay/soak gate.
