...
def test_port_profile_shares_bounded_gpu_with_siglip2():
    ...
    assert installer.PORT_ENV["EVOSSEARCH_LUXRIOT_SNAPSHOT_INTERVAL"] == "1"
    assert installer.PORT_ENV["EVOSSEARCH_LUXRIOT_DEFAULT_BATCH_SIZE"] == "12"
    assert installer.PORT_ENV["EVOSSEARCH_LUXRIOT_SUMMARY_MAX_BATCH_FRAMES"] == "16"
    assert installer.PORT_ENV["EVOSSEARCH_LUXRIOT_VLM_MAX_IMAGES_PER_REQUEST"] == "8"
    assert installer.PORT_ENV["EVOSSEARCH_LUXRIOT_L0_MAX_SELECTED_FRAMES"] == "8"
