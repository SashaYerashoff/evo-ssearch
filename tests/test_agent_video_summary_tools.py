...
class AgentVideoSummaryToolTests(unittest.TestCase):
    ...
    def test_live_turn_uses_small_route_specific_video_prompt(self):
        ...
        self.assertIn("In ordinary conversation, answer the person directly", scoped)
        self.assertIn("Do not volunteer EVA's architecture, tool state", scoped)
        self.assertNotIn("interactive intellectual core", scoped)
