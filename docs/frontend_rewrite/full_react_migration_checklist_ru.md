...
- [x] На Archive, Stream Summaries и Probes шапка вкладок и фильтров закреплена
  ...
  Под контролами активного `.atp-tabpanel-content` медленно проходит едва
  заметная размытая «река света»; она не перехватывает ввод и отключается общим
  режимом reduced/no motion. Сам
