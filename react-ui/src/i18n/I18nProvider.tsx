...
const EN = {
  ...
  'nav.pinMenu': 'Keep the menu open',
  'nav.unpinMenu': 'Collapse the menu',
  ...
  'video.reloadChannels': 'Reload channels',
  ...
  'incident.operatorCriterion': 'Operator criterion',
  'incident.safetySignal': 'Safety signal',
  'incident.contextCandidate': 'Context candidate',
  'incident.noCover': 'No grounded cover',
  'incident.awaitingReview': 'Incident awaiting review',
  'incident.observedFor': 'Observed',
  'incident.caseAge': 'Case age',
  'incident.lastEvidence': 'Last evidence',
  'incident.evidence': 'Evidence',
  'incident.uncertain': 'Uncertain',
  'incident.coverage': 'Coverage',
  'incident.ongoingEvidence': 'Ongoing evidence',
  'incident.episodeEnded': 'Episode ended',
  'incident.caseOpen': 'Case open',
  'incident.following': 'Following',
  'incident.activeRisk': 'Active risk',
  'incident.criticalRisk': 'Critical risk',
} as const
...
const LV: Record<TranslationKey, string> = {
  ...
  'nav.pinMenu': 'Paturēt izvēlni atvērtu',
  'nav.unpinMenu': 'Sakļaut izvēlni',
  ...
  'video.reloadChannels': 'Pārlādēt kanālus',
  ...
  'incident.operatorCriterion': 'Operatora kritērijs',
  'incident.safetySignal': 'Drošības signāls',
  'incident.contextCandidate': 'Konteksta kandidāts',
  'incident.noCover': 'Nav piesaistīta attēla',
  'incident.awaitingReview': 'Incidents gaida pārskatīšanu',
  'incident.observedFor': 'Novērots',
  'incident.caseAge': 'Lietas vecums',
  'incident.lastEvidence': 'Pēdējais pierādījums',
  'incident.evidence': 'Pierādījumi',
  'incident.uncertain': 'Neskaidri',
  'incident.coverage': 'Pārklājums',
  'incident.ongoingEvidence': 'Turpinās novērojumi',
  'incident.episodeEnded': 'Epizode beigusies',
  'incident.caseOpen': 'Lieta atvērta',
  'incident.following': 'Izsekošana',
  'incident.activeRisk': 'Aktīvs risks',
  'incident.criticalRisk': 'Kritisks risks',
}
