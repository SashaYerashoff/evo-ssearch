...
class Config:
    ...
    try:
        LUXRIOT_PROBE_BUFFER_FRAMES = int(os.getenv('EVOSSEARCH_LUXRIOT_PROBE_BUFFER_FRAMES', '12'))
    except (TypeError, ValueError):
        LUXRIOT_PROBE_BUFFER_FRAMES = 12
    if LUXRIOT_PROBE_BUFFER_FRAMES < 1:
        LUXRIOT_PROBE_BUFFER_FRAMES = 1
    if LUXRIOT_PROBE_BUFFER_FRAMES > 120:
        LUXRIOT_PROBE_BUFFER_FRAMES = 120
