...
6. Use `depth="live"`/`L0` only around selected event windows.
7. Pull VLM archive frames with `include_evidence_frames=true` or `get_detections source="vlm_summary"/"vlm_alert"`.
